...
class LittleBigSearchGUI():
    ...
    def _bound_to_mousewheel(self, event):
        ...
        self.scrollerCanvas.bind_all("<Button-4>", self._on_mouse_wheel)
        self.scrollerCanvas.bind_all("<Button-5>", self._on_mouse_wheel)

    def _unbound_to_mousewheel(self, event):
        
        self.scrollerCanvas.unbind_all("<Button-4>")
        self.scrollerCanvas.unbind_all("<Button-5>")
    ...
    def _on_mouse_wheel(self, event):
        ...
        if event.num == 4:
            ...
            move = 1
        self.scrollerCanvas.yview_scroll(move, "units")
    ...
    def showPagingButtons(self):
        ...
        self.pageLeft.grid(column=1, row=5, ipadx=15, pady=(0, 0), padx= (0, 190))
        self.pageFarLeft.grid(column=1, row=5, ipadx=10, pady=(0, 0), padx= (0, 330))
        
        self.pageRight.grid(column=1, row=5, ipadx=15, pady=(0, 0), padx= (190, 0))
        self.pageFarRight.grid(column=1, row=5, ipadx=10, pady=(0, 0), padx= (330, 0))

        self.levelCounter.grid(column=1, row=5, ipadx=10, pady=(0, 0), padx= (580, 0))
    ...
    def showResult(self,levels, isAfterSearch: bool= True):        
        ...
        for index, level in enumerate(levels):
            ...
            if index != len(levels) - 1:
                lineSeperator = tk.Frame(scrollerFrame, bg=GB.BGColorLight, height=1, bd=0)
                lineSeperator.grid(row= index, column=1, columnspan=2, ipadx=(250), pady=(110,0))
